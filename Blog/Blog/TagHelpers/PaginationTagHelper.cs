...
namespace BlogApp.TagHelpers
{
    ...
    public class PaginationTagHelper:TagHelper
    {
        ...
        public PaginationTagHelper(IUrlHelperFactory _urlHelperFactory)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (PaginationModel.TotalPages > 1 && PaginationModel.CurrentPage != 1)
            {
                ...
                previousLink.Attributes["href"] = urlHelper.Action(ActionMethod, new { categoryId= CurrentCategoryId, page = PaginationModel.CurrentPage - 1 });
            ...
            for(int i=1; i <= PaginationModel.TotalPages; i++)
            {
                ...
                a.Attributes["href"] = urlHelper.Action(ActionMethod, new { categoryId = CurrentCategoryId, page = i });
            ...
            if (PaginationModel.TotalPages > 1 && PaginationModel.CurrentPage != PaginationModel.TotalPages)
            {
                ...
                nextLink.Attributes["href"] = urlHelper.Action(ActionMethod, new { categoryId = CurrentCategoryId, page = PaginationModel.CurrentPage + 1 });
